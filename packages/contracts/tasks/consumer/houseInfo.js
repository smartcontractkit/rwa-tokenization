const {
  ...
  task("func-request-houseInfo", "Initiates an on-demand request from a Functions consumer contract")
    ...
    .addParam("tokenid", "Billing subscription ID used to pay for the request")
    .addOptionalParam(
      "simulate",
    ...
    .setAction(async (taskArgs, hre) => {
      ...
      const requestTx = await consumerContract.requestHouseInfo(
        tokenId
      )
